  ...
  return (
    <MainLayout>
      ...
      <Descriptions className="membership-des" title="Chương trình phát triển đối tác">
        <Descriptions.Item className="pb-0">Bạn sẽ nhận được tiền thưởng mỗi khi người được bạn giới thiệu mở tài khoản và đầu tư. Thưởng sẽ được trả vào tháng kế tiếp.
